          ...
          revapi268 = tpj("#rev_slider_268_1").show().revolution({
            ...
            navigation: {
              ...
              arrows: {
                ...
                hide_under:767,
                hide_onleave:false,
                tmp:'<div class="tp-arr-imgwrapper"><div class=""></div></div>',
                left: {
                  h_align:"left",
                  v_align:"center",
                  h_offset:0,
          ...
          revapi270 = tpj("#rev_slider_270_1").show().revolution({
            ...
            navigation: {
              ...
              arrows: {
                ...
                hide_delay:200,
                hide_delay_mobile:0,
                tmp:'<div class="tp-arr-allwrapper">  <div class=""></div>  <div class="tp-arr-titleholder">{{title}}</div> </div>',
                left: {
                  h_align:"left",
                  v_align:"center",
                  h_offset:20,
          ...
          revapi271 = tpj("#rev_slider_271_1").show().revolution({
            ...
            navigation: {
              ...
              arrows: {
                ...
                hide_under:767,
                hide_onleave:false,
                tmp:'<div class="tp-title-wrap">    <div class=""></div>    <div class=""></div> <span class="tp-arr-titleholder">{{title}}</span> </div>',
                left: {
                  h_align:"left",
                  v_align:"center",
                  h_offset:20,
          ...
          revapi261 = tpj("#rev_slider_261_1").show().revolution({
            ...
            navigation: {
              ...
              arrows: {
                ...
                hide_under:767,
                hide_onleave:false,
                tmp:'<div class="tp-title-wrap">  <span class="tp-arr-titleholder">{{title}}</span>    <span class=""></span> </div>',
                left: {
                  h_align:"left",
                  v_align:"center",
                  h_offset:20,
